...
We included a dataset if they were considered important for the question or revealed important information. We included the race dataset as it gave the main information of the paper in the form of birth rate information for different age groups and races. We also included the numbirth dataset as it had information on birthrates for all the age groups together. We used birthhist as it gave the breakdown on birth rates by both age group and race. We used birth1 as well as it had data for young women age groups birth rates, as well as total population data and demographic data for each race and age combination. birth2 had total population data for each age group and race-age combination. We used rent, student_debt, religion, and childcare as they provided information on the change in rental cost, student debt, importance of religion and rise in child costs, which might have a relationship with the birth rates. 
...
birthrates = fulltable %>%
  filter(year == 2000 | year==2019) %>%
  mutate(w15brate = white15/sumw15*1000, w20brate = white20/sumw20*1000, b15brate = black15/sumblack15*1000, b20brate = black20/sumblack20*1000, h15brate = hisp15/sumhsp15*1000, h20brate = hisp20/sumhsp20*1000) %>%
