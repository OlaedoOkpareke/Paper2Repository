...
```{r figsix, out.width="90%", fig.cap = "Average Birth Rates Vs level of Unemployment for the 15 to 19 and 20 to 24 age groups from 2000 to 2020", echo = FALSE}
...
There were datasets in which we had to make generalizations about a specific population based on data of a general population. For example, in (Figure \@ref(fig:figseven)), the map data was composed of responses taken from women aged from 20-34, as information for the 15 to 24 age group were not available. Due to this, conclusions that are made from this map are likely not accurate as they are not the true statistics of the 15 to 24 age group. Our research question wanted to focus on the trend of birth rates over a 20 year period, specifically from 2000 to 2020. However, for several datasets only data up to 2019 was available. Due to this, instead of being able to compare 2000 and 2020 explicitly, we had to generalize trends that we see in 2019 to be at least similar to trends that we’d see in 2020. We had the same problem with (Table \@ref(tab:tabtwo)), in which we had to approximate 2004 to 2000 even though situations would be different. 
